...
public class LinkedList<E> implements List<E> {
    ...
    public E remove(int index) {
        ...
        /**
         * int j = 0; // Se empieza con el segundo porque ya validamos que hacer
         * con el first for(Node<E> i = first.getNext(); i != null; i =
         * i.getNext()){ if(j == index){ Node<E> previo = getPrevious(i);
         * previo.setNext(i.getNext()); i.setNext(null); efectivo--; return
         * i.getData(); } j++; } return null;*
         */
    }
    ...
    public List<E> findBetween(Comparator<E> cmp, E element1, E element) {
        ...
        while (iterator.hasNext()) {
            E e = iterator.next();
            if (((cmp.compare(e, element1)) == 1) && ((cmp.compare(e, element)) == -1)) {
                results.addLast(e);
            }
        }
        return results;
